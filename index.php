...
<head>
  ...
  <!-- Bootstrap and css-->
  <link href="assets/bootstrap/css/bootstrap.paper.css" rel="stylesheet">
...
<div class="welcome-home">
  <div class="container-fluid">
    <img src="assets/images/logo.png" alt="Santa Rosa de la Yunga">
    <h1>Bienvenidos a <br><strong class="welcome">Santa Rosa de la Yunga</strong></h1>
...
<nav class="navbar navbar-default" role="navigation">
  <div class="container-fluid"><!-- Brand and toggle get grouped for better mobile display -->
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Yunga</a>
    </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a href="#">Cataratas</a></li>
            <li><a href="#">Paisajes</a></li>
            <li><a href="#">Naturaleza</a></li>
            <li><a href="#">Atardecer</a></li>
          </ul>
        </li>
      </ul>
    </div><!-- /.navbar-collapse -->
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <div class="pull-left">
          ...
          <span class="left-10"><i class="fa fa-heart"></i> 150 Likes</span>
        </div>
...
$(function () {
  ...
  // init Isotope
  // var $container = $('.isotope-content').isotope({
  //   itemSelector: '.item',
  //   layoutMode: 'masonry'
  // });
